...
{#if lemma && /\p{L}+/u.test(lemma)}
	<div
		in:fade|global
		class="absolute right-2 bottom-8 z-30 min-h-40 w-72 overflow-y-scroll rounded border-1 border-r-4 border-b-3 border-gray-400 bg-white px-2 md:bottom-2 lg:max-h-[80%]">
